...
export default styled(Button)(({ theme, ownerState }) => {
  ...
  const { white, text, transparent, gradients, dark, info2 } = palette;
  ...
  const containedStyles = () => {
    ...
    const boxShadowValue = colored[color]
      ? `${boxShadow([0, 0], [0, 0], palette[color].main, 0)}, ${boxShadow(
        [0, 0],
        [0, 0],
        palette[color].main,
        0.2
      )}, ${boxShadow([0, 0], [0, 0], palette[color].main, 0)}`
      : "none";
    ...
    return {
      ...
      "&:focus:not(:hover)": {
        ...
        boxShadow: palette[color]
          ? boxShadow([0, 0], [0, 0], palette[color].main, 0)
          : boxShadow([0, 0], [0, 0], white.main, 0),
      },
  ...
  const textStyles = () => {
    // background color value
    const backgroundValue = palette[color] ? info2.main : info2.main;
    // color value
    const colorValue = palette[color] ? palette[color].main : white.main;
